									...
									<DropdownMenu>
										...
										>
											<DropdownMenuLabel className="text-xs line-clamp-2 font-normal">
												Connecté en tant que <span className="font-medium block text-primary">{user?.name}</span>
											</DropdownMenuLabel>
											<DropdownMenuSeparator />
											<DropdownMenuItem
												asChild
						...
						<Sheet>
							...
							<SheetContent>
								...
								<div className={`flex-col mt-4 gap-3 ${user ? "flex" : "hidden"}`}>
									...
									<SheetClose>
										<button className="font-medium text-red-600 hover:text-red-400 w-full py-3 text-sm flex justify-start gap-2">
											<DoorClosed size={20} />
											Se déconnecter
										</button>
									</SheetClose>
